...
namespace eAppointment.Backend.Application.Validators
{
    public class CreatePatientCommandValidator : AbstractValidator<CreatePatientCommand>
    {
        ...
        public CreatePatientCommandValidator(UserManager<User> userManager, IStringLocalizer<object> localization)
        {
            _userManager = userManager;
            _localization = localization;

            var validationMessagePath = "Features.Admins.CreatePatient.ValidationMessages";
